...
-- @string message
-- @usage wesnoth.message "Hello World!"
-- @usage wesnoth.message("Big Brother", "I'm watching you.") -- will result in "<Big Brother> I'm watching you."
...
-- @function wesnoth.clear_messages
wesnoth.clear_messages = () ->

----
-- @function wesnoth.textdomain
...
-- @usage wesnoth.select_hex(14,6, true, true)
wesnoth.select_hex = (x, y, show_movement=true, fire_events=false) ->

----
-- Reverses any select_hex call, leaving all locations unhighlighted. Takes no arguments.
-- @function wesnoth.deselect_hex
...
-- @function wesnoth.play_sound
-- @string sound
-- @bool repeat_count
-- @usage wesnoth.play_sound "ambient/birds1.ogg"
-- @usage wesnoth.play_sound("magic-holy-miss-3.ogg", 4) -- played 1 + 4 = 5 times
...
-- @function wesnoth.show_popup_dialog
...
-- @usage wesnoth.set_dialog_markup(true, "notice_label")
...
-- @usage wesnoth.set_dialog_focus("my_listbox")
...
-- @usage wesnoth.set_dialog_visible(false, "secret_button")
...
----
-- @function wesnoth.skip_messages
...
----
-- @function wesnoth.get_displayed_unit
