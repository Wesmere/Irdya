...
wsl_action
    ...
    id: "set_variable"
    description: [[The [set_variable] tag is used to create and manipulate WSL variables. The VARIABLE macro is a quick syntactic shortcut for simple variable creation and the VARIABLE_OP macro is a quick syntactic shortcut for performing simple mathematical operations on variables.]]
