...
GENERIC_UNIT_TEST "unit_spawns_at_nearest_vacant_hex", ->
    event
        name:"Start"
        command: ->
            unit UNIT 2, "Orcish Grunt", 3, 4, {}
            unit UNIT 2, "Orcish Grunt", 3, 3, {}
            unit UNIT 2, "Orcish Grunt", 4, 3, {}
            unit UNIT 2, "Orcish Grunt", 4, 4, {}
            unit UNIT 2, "Orcish Grunt", 2, 3, {}
            unit UNIT 2, "Orcish Grunt", 2, 4, {}

            unit UNIT 1, "Orcish Grunt", 3, 4, {}
