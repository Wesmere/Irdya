...
scenario
    id:"03_Wasteland"
    name: _ "Wasteland"
    map:"03_Wasteland.map"
    turns:24
    next_scenario:"04_Valley_of_Trolls"

    time:DEFAULT_SCHEDULE

    music:{"elvish-theme", "casualties_of_war", "nunc_dimittis"}
    ...
    side: FLAG_VARIANT6 "ragged"
        ...
        gold: QUANTITY 100, 120, 160
        income: QUANTITY 8, 12, 12
        team_name:"Orcs"
    ...
    Prestart: ->
        objectives HINT _ "There are no villages in this scenario — you must use healers instead. Use hit-and-run tactics to weaken enemy units who cannot heal themselves."
            objective:
    ...
    event:
        ...
        command: ->
            temporary = orcs_recruited % modulo_factor
    ...
    Victory: ->
        ...
        if camp_gold > 50 and camp_gold <= 100
            message
                role:"advisor"
        ...
        camp_gold,orcs_recruited,modulo_factor = nil,nil,nil
