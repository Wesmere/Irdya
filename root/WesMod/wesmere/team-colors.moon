...
-- #
-- # Each item in a color definition list is an exact rgb value recognized as
-- # belonging to that color and thus getting recolored.
...
--     # if blue is still used somewhere (water recoloring?) it needs to be renamed
--     # to not clash with color_range blue
